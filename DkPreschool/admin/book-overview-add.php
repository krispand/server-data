...
<label class="checkbox"><input name="book_feature" type="checkbox" value="1" /> Popular Book</label> <!-- Feature to Popular -->
<!--<label class="checkbox"><input name="book_onoffer" type="checkbox" value="1" /> On Offer</label>
<label class="checkbox"><input name="book_readaloud" type="checkbox" value="1" /> Read Aloud</label>--><!-- Commented for PreSchool -->
</div></div>
