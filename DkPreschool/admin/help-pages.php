<?
 ...
 // ### set default data filter criteria here
	$searchStr = '';
	$colsArray = array('helppage_auto_id','helppage_section_guid','helppage_section','helppage_count','region_code','helppage_section_status','helppage_region_id','helppage_section_order');
...
<div class="clearfix">
  ...
  <a href="help-pages-add.php"><button id="" class="btn green">Add New <i class="icon-plus"></i></button></a>
  </div>
...
<div class="space15"></div>
                                   ...
                                   if($regionID != $record['helppage_region_id']){
									   ...
									   if($_SESSION['login_region']==0){
									  	 ...
									  	 echo '<h4>'.$record['region_code'].' Help Page Sections</h4>';
									   }
									   ...
									   echo '<table class="table table-striped table-hover table-bordered dragtable-sample" id="dragtable-sample'.$i.'">
											 ...
											 <tr>
												 <th>Help Section</th>
												 <th width="15%">Amount of Pages</th>
											 ...
											 <tbody>';
											 $regionID =  $record['helppage_region_id'];		
								   }
                                     ...
                                     echo  '<tr id="helpmain_'.$record['helppage_section_guid'].'">
                                            <td>'.$record['helppage_section'].'</td>
                                            <td>'.$record['helppage_count'].'</td>
                                            <td>'.$record['region_code'].'</td>
                                            <td>'.$record['helppage_section_status'].'</td>
                                            <td><a href="help-pages-edit.php?sect='.$record['helppage_section'].'&id='.$record['helppage_section_guid'].'&rid='.$record['helppage_region_id'].'">Edit</a></td>
											<td><a href="help-pages-add.php?sect='.$record['helppage_section'].'&id='.$record['helppage_section_guid'].'&rid='.$record['helppage_region_id'].'">Add</a></td>
											<td><a href="#" onclick="funcDelete(\'helpmain\',\''.$record['helppage_section_guid'].'\',\''.$record['helppage_section'].'\');return false"><i class="icon-trash" style="font-size:18px"></i></a></td></tr>';	
								   $i++;
								   }
                                   ?>
									<?
